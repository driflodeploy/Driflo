...
const CallToActionButtons = () => (
  <div className="flex items-center space-x-4">
    <Link href="https://calendly.com" target="_blank" rel="noopener noreferrer">
      <Button className="group relative bg-gradient-to-r from-purple-600 via-purple-500 to-indigo-600 hover:from-purple-700 hover:via-purple-600 hover:to-indigo-700 text-white rounded-full px-10 py-6 font-semibold text-lg shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 ease-out overflow-hidden">
...
export default function HeroSection() {
  return (
    <section
      id="home"
      className="w-full px-4 lg:px-6 py-12 lg:py-10 pt-24 mb-20"
    >
